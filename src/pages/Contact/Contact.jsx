...
function Contact() {
  ...
  const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_0crmx3o', 'template_o06jvqa', e.target , 'YLLPXLlqt4hijSswO')
        .then((result) => {
        ...
        <div className={contactstyle.container}>
            <div className={contactstyle.contact_headline}>
              <div className={contactstyle.headline_text}>
                <ul>
                    <Link to='/' className={contactstyle.home}>Home</Link>
                  ...
                  <div className={contactstyle.name_phone_mail_div}>
                    ...
                    <div className={contactstyle.form_name}>
                      <div className={contactstyle.name1}>
                        ...
                        <input className={contactstyle.inp} type='text' name='name' value={nameinput} onChange={Inpnameval}/>
                      </div>
                    </div>
                    ...
                    <div className={contactstyle.form_phone}>
                      <div className={contactstyle.phone1}>
                        ...
                        <input className={contactstyle.inp} type='tel' name='phone' value={phoneinput} onChange={Inpphoneval}/>
                      </div>
                    </div>
                    ...
                    <div className={contactstyle.form_mail}>
                      <div className={contactstyle.mail1}>
                        ...
                        <input className={contactstyle.inp} type='email' name='email' value={emailinput} onChange={Inpemailval}/>
                      </div>
                    </div>
                  </div>
